    ...
    <table border="1" class="table table-striped table-hover">
        ...
        <c:forEach var="product" items="${products}">
            <tr>
                ...
                <td>${product.price}</td>
                <td><a href="${pageContext.request.contextPath}/updateProduct?productId=${product.id}">Update
                    product</a></td>
                <td><a href="${pageContext.request.contextPath}/deleteProduct?productId=${product.id}"
